  ...
  return (
    <div className='w-3/4 h-1/2 flex flex-col'>
      <div className='text-white'>
        <p className='text-center text-2xl'>Bienvenido : {userSession}</p>
      </div>
        <div className="text-white w-full h-2/3 flex items-center justify-center">
            <button onClick={goMemory} className="BoxOpaque m-4 w-1/4 h-1/2 text-lg hover:BoxViolet ">Memoria</button>
            <button onClick={goSearchmines} className="BoxOpaque m-4 w-1/4 h-1/2 text-lg hover:BoxViolet ">Buca Minas</button>
        ...
        <div className="text-white w-full h-1/3 flex items-center justify-between">
            ...
            <button onClick={fncHelp} className="BoxOpaque m-4 w-1/4 h-1/2 text-lg hover:BoxViolet ">Info</button>
        </div>
    </div>
  )
}
